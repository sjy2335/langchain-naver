...
from langchain_naver.legacy.chat_models import (
    ChatClovaX,
...
@patch(
    "langchain_naver.legacy.ChatClovaX._completion_with_retry",
...
@patch(
    "langchain_naver.legacy.ChatClovaX._acompletion_with_retry",
